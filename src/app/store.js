...
export default function configureStore(initialState = Map()) {
    ...
    // Batch action store notify
    // https://github.com/reactjs/react-redux/issues/263
    const notifyFunction = (notify) => {
        notify()
    }
    const debounceNotifyFunction = _.throttle(notifyFunction, 50) // throttle because of scrollbar (leading is true)
